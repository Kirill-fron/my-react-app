                ...
                <div className="moskvin-lesson">
                  ...
                  <div className="moskvin-lesson-back">
                    <div className="moskvin-lesson-announce">
                      <ul>
                        <li>
                          Знакомство с программой Blender, инструменты
                          для анимации
                        </li>
                        <li>Ключевые кадры и манипуляции с ними</li>
                        <li>
                          Разбор интерполяции, значение постоянной,
                          линейной и Безье интерполяции
                        </li>
                  ...
                  <div className="moskvin-lesson-back">
                    <div className="moskvin-lesson-announce">
                      <ul>
                        ...
                        <li>
                          Анимация мяча, пинг-понга, плавающей рыбки
                        </li>
                        <li>
                          Знакомство с программой After Effects,
                          композинг и постобработка
                        </li>
                      </ul>
                    </div>
                  </div>
                    ...
                    <div className="moskvin-lesson-announce">
                      <ul>
                        ...
                        <li>
                          ...
                          прыжки, перекаты. Старт и стоп анимации
                          движения
                        </li>
                        <li>
                        ...
                        <li>
                          Взаимодействие Blender с Mixamo, ретаргет
                          анимации
                        </li>
                      </ul>
                    </div>
                  ...
                  <div className="moskvin-lesson-back">
                    <div className="moskvin-lesson-announce">
                      <ul>
                        ...
                        <li>
                          Продуктовая анимация в программе Blender
                        </li>
                        <li>Применение модификаторов для анимации</li>
                        <li>
                          Разбор Geometry Nodes и их применение для
                          анимации
                        </li>
                        <li>
                        ...
                        <li>
                          Особенности постобработки моушн дизайна в
                          After Effects
                        </li>
                      </ul>
                    </div>
                  ...
                  <div className="moskvin-lesson-back">
                    <div className="moskvin-lesson-announce">
                      <ul>
                        ...
                        <li>
                          Инструменты захвата движений и синхронизация
                          речи с озвучкой
                        </li>
                      </ul>
                    </div>
                  ...
                  <div className="moskvin-lesson-back">
                    <div className="moskvin-lesson-announce">
                      <ul>
                        ...
                        <li>
                          Расположение в кадре, манипуляция взглядом
                          зрителя
                        </li>
                        <li>Разбор особенностей работы с камерой</li>
                        <li>
                          Приемы построения композиции при работе со
                          светом, контрастом, фокусом
                        </li>
                        <li>
                          Освоение приемов анимации движущейся камеры
                        </li>
                  ...
                  <div className="moskvin-lesson-back">
                    <div className="moskvin-lesson-announce">
                      <ul>
                        ...
                        <li>
                          Перенос анимации из Blender в Unreal Engine
                        </li>
                        <li>
